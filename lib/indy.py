...
class Blueprint(object):
    ...
    def fetchBpData(self, sde = None):
        ...
        self.product = self.activities['manufacturing']['products'][1]['typeID']
        self.product_quantity = self.activities['manufacturing']['products'][1]['quantity']
...
class SDE(object):
    ...
    def __init__(self):
        ''' '''
        self.db_location_csv = '../database/'
        self.db_location_YAML = '../database/sde/fsd/'
        self.db_list = []
